...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val tema2 = Producto("Aprende a manejar las Activities",R.drawable.activity,"Una Activity es un componente de la aplicación que contiene una pantalla con la que los usuarios pueden interactuar para realizar una acción, como marcar" +
                " un número telefónico, tomar una foto, enviar un correo electrónico o ver un mapa. A cada actividad se le asigna una ventana en la que se puede dibujar su interfaz de usuario.",R.drawable.amalia )
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        ...
        when (item.itemId) {
            R.id.itmAcerca -> {
                ...
                "Creado por Amalia Guadalupe Orta Centeno.\n"+"GDS0142"
            }
            R.id.itmObjetivo -> {
